    ...
    : wxScrolledWindow(parent, id)
{
    ...
    //_chatLogic = new ChatLogic(); //original

    // pass pointer to chatbot dialog so answers can be displayed in GUI
    _chatLogic->SetPanelDialogHandle(this); // Task 1
    //_chatLogic->SetPanelDialogHandle(this); //original
...
ChatBotPanelDialog::~ChatBotPanelDialog()
{
    //// STUDENT CODE
    ////
	//Task 1: no need to manually deallocate smart pointer
    // delete _chatLogic;
